...
if __name__ == '__main__':
    ...
    visible_dir = "/home/groupyun/桌面/sdd_new/2024F19_dfog/M3FDv2/M3FDv3_/Vis"
    infrared_dir = "/home/groupyun/桌面/sdd_new/2024F19_dfog/M3FDv2/M3FDv3_/Inf"
    vis_gt_dir = "/home/groupyun/桌面/sdd_new/2024F19_dfog/M3FDv2/M3FDv3_/gt"
    train_dataset = ImageFusionDataset(visible_dir, infrared_dir, visible_gt_dir=vis_gt_dir)
    ...
    model.load_state_dict(torch.load('runs/model_49.pth'))
    ...
    for epoch in range(Epoch):
        ...
        for visible_image, infrared_image, visible_image_gt, visible_image_224 in train_tqdm:
        ...
        torch.save(model.state_dict(), f'{save_path}/model_{epoch}_finetune.pth')
