...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_path', metavar='DIR', default='/home/groupyun/桌面/sdd_new/2024F19_dfog/M3FDv2/class_',
    ...
    if args.arch == 'cls_model':
        model = CLIPClassifier(num_classes=9)
        model = model.cuda()
        #model.load_state_dict(torch.load('pretrained/best_cls.pth'))
        ...
        for epoch in range(args.start_epoch, args.epochs):
            ...
            if epoch == args.epochs-1:
                ...
                # 保存最佳模型权重
                if best_prec1 < prec1:
                    torch.save(model, f'{args.save_path}/best_cls.pth')
                    best_prec1 = prec1
